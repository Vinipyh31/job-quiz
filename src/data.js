...
const jobs = [
    { id: 1, name: "📍 Специалист по логистике", description: "Вы изучите основы транспортной, складской, производственной, сбытовой, реверсивной логистик, а также логистики снабжения и закупок." , score: 0 },
    { id: 2, name: "Специалист по ручному тестированию ПО", description: "В результате вы сможете понимать как правильно тестировать ПО, разрабатывать тест планы и др." , score: 0 },
    { id: 3, name: "🎨 UI-дизайнер", description: "Программа будет полезна тем, кто хочет работать в области дизайна интерфейсов, веб-дизайна, продуктового дизайна или проектирования интерфейсов" , score: 0 },
    { id: 4, name: "😊 Специалист клиентского сервиса", description: "Данная программа будет интересна всем желающим стать специалистами в оказании качественного сервиса клиентам организации." , score: 0 },
    { id: 5, name: "📃 Делопроизводитель", description: "В результате обучения вы сможете осуществлять организацию документооборота." , score: 0 },
    { id: 6, name: "⛱️ Вендор на маркетплейс", description: "После обучения вы сможете выбирать товары, организовывать логистику и развивать новый магазин." , score: 0 },
    { id: 7, name: "✅ Специалист в сфере гос.закупок", description: "Программа будет интересна как заказчикам, так и поставщикам и рассматривает процесс закупок с точки зрения 44-ФЗ и по 223-ФЗ." , score: 0 },
    { id: 8, name: "🗣 Куратор программ онлайн-образования", description: "Курс подготавливает кураторов.  Вы научитесь принципам коммуникации, мотивации и разрешения конфликтов со студентами курса." , score: 0 },
    {
        id: 9, name: "🚀 Цифровой маркетинг", description: "Программа будет полезна для желающих работать в сфере интернет- продвижения, контекстной рекламы и создания посадочных страниц." , score: 0 },
    { id: 10, name: "🌍 Предприниматель в онлайн", description: "Программа для предпринимателей, которые хотят развиваться, совершенствовать свои знания и умения в области бизнес-проектирования." , score: 0 },
    { id: 11, name: "📂 Менеджер онлайн-проектов", description: "В результате обучения вы сможете развивать проекты, организовывать исследования, разрабатывать план развития и продвижения." , score: 0 },
    { id: 12, name: "✍️ Контент-менеджер", description: "Вы научитесь управлять процессами создания контента, моделировать стратегию. А также изнутри изучите каждый этап работы. " , score: 0 },
    { id: 13, name: "👥 Кадровое администрирование", description: "Вы научитесь вести кадровый учет, оформлять трудовые отношения, разрабатывать и вести документацию, связанную с управлением персоналом" , score: 0 },
    { id: 14, name: "🎯 Таргетолог и SMM- специалист", description: "Вы научитесь разрабатывать стратегии продвижения, обосновывать и выбирать каналы продвижения с точки зрения их эффективности и др." , score: 0 }
]
