...
const Hello = ({setStartTest}: HelloPageProps) => {
    return (
        <div className='Hello'>
            ...
            <div className="main__container">
                <p>Мы создали специальный психологический тест,
                    на основе которого вы сможете выбрать именно ту профессию, которая близка вам по ценностям,
                    характеру деятельности и вашим личным способностям.
                </p>
                <MyButton className='btn' type='big' onClick={() => {
                    setStartTest(true)
                }}>начать тест</MyButton>
